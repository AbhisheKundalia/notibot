...
public final class Utils {
     ...
     */
    public static String fetchReplyData(String requestUrl) {
        // Create URL object
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            urlConnection.setRequestProperty("Authorization", "Bearer 4aa2ef0120b84ef2a8ad3ec3b6a7aaae");
            ...
            Log.e(LOG_TAG, "Problem retrieving the notificationResponse JSON results.", e);
        } finally {
    ...
    /**
     * Return an String response by parsing out information
     * about the first Notification Response from the input NotificaionResponseJSON string.
     */
    private static String extractResponseFromJson(String notificationResponseJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(notificationResponseJSON)) {
            return null;
        }

        try {
            JSONObject baseJsonResponse = new JSONObject(notificationResponseJSON);
